...
#ifndef SORT_H
#define SORT_H
#include <windows.h>    // Нужно, для установки правильного ввода кириллицы и вывода
#include "Air.h"
...
void rus(int r) {
	if (r == 1) {
		SetConsoleCP(1251);         // Эта функция ставит консоли кодировку для правильного чтения с клавиатуры
	}
	else { SetConsoleOutputCP(1251); } // "Эта функция выводит нормальную кириллицу при выводе русских символов на экран
}
